...
fs.writeFileSync(path.join(__dirname, 'src/app/core/services/saud-farah-agent.service.ts'), fileContent, 'utf8');
console.log('SaudFarahAgentService written successfully!');
